...
const Navbar = () => {
  ...
  return (
    <>
      {/* 🔥 Top Bar (fixed color) */}
<div className="fixed top-0 left-0 right-0 z-40 bg-black/70 text-white backdrop-blur-md h-12 flex items-center justify-center text-sm font-medium"> Registrations Open - Limited Slots</div>
